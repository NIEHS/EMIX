...
A mixtures workflow can be applied to statistical analysis considerations for environmental mixtures data (Joubert et al., Environmental Health Perspectives 2025 DOI: 10.1021/EHP.6c00155). The strategy builds on epidemiological and statistical principles, tailored to specific nuances of the mixtures’ context. The workflow involves six steps (Figure 1), three of which can be considered by using the accompanying EMIX_Methods table.  
